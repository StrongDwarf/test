package com.demo.xiaobaicai.androiddemo.okHttp;
...
public class HttpConfig{
    ...
    private String userAgent="";  //用户代理，它是一个特殊字符串头，使得服务器能够识别客户使用的
                                  //操作系统及版本，CPU类型，浏览器及版本，浏览器渲染引擎，浏览器语言
                                  //浏览器插件等
    private boolean agent = true; //有代理的情况不能访问。true:有代理能访问，false:有代理不能访问
